...
- `WorkerConnector.HandleWorkerConnectionFailure` has been removed and `WorkerConnector.Connect` now throws exceptions for connection errors instead.
...
- `WorkerConnector` no longer destroys itself in `Dispose`.
